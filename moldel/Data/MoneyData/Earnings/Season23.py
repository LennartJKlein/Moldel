...
exercises1 = [
    ...
    Exercise(episode=1, alive=players1, maximum=1500, earned=[
        Earning(money=1500, major={Player.FRESIA_23, Player.GLEN_23, Player.THOMAS_23, Player.ARNO_23, Player.EVERON_23,
                Player.HILA_23, Player.KIM_LIAN_23, Player.LAETITIA_23, Player.SAHIL_23, Player.SUZANNE_23, Player.WELMOED_23}),
    ]),
...
exercises2 = [
    ...
    Exercise(episode=2, alive=players2, maximum=2500, earned=[
        ...
        Earning(money=200, major={Player.ARNO_23, Player.EVERON_23,
                Player.KIM_LIAN_23, Player.THOMAS_23, Player.LAETITIA_23}),
    ...
    Exercise(episode=2, alive=players2, maximum=1800, earned=[
        Earning(money=400, major={Player.HILA_23, Player.GLEN_23, Player.ARNO_23},
        ...
        Earning(money=200, major={Player.LAETITIA_23, Player.EVERON_23,
                Player.KIM_LIAN_23}, minor={Player.THOMAS_23, Player.FRESIA_23})
    ])
]
...
exercises5 = [
    ...
    Exercise(episode=5, alive=players5, maximum=3000, earned=[
        Earning(money=725, major={Player.KIM_LIAN_23, Player.SAHIL_23,
                Player.LAETITIA_23, Player.EVERON_23, Player.HILA_23, Player.FRESIA_23}),
        Earning(money=75, major={Player.THOMAS_23})
    ]),
    # Opdracht 3: Tijdsbeeld
    Exercise(episode=5, alive=players5, maximum=2000, earned=[
        Earning(money=2000, major={Player.EVERON_23, Player.FRESIA_23, Player.HILA_23,
                Player.KIM_LIAN_23, Player.LAETITIA_23, Player.SAHIL_23, Player.THOMAS_23})
    ])
]
...
exercises6 = [
    ...
    Exercise(episode=6, alive=players6, maximum=3500, earned=[
        Earning(money=1400, major={Player.KIM_LIAN_23, Player.THOMAS_23, Player.SAHIL_23},
    ...
    Exercise(episode=6, alive=players6, maximum=1740, earned=[
        Earning(money=1310, major={Player.KIM_LIAN_23, Player.THOMAS_23, Player.SAHIL_23,
                Player.FRESIA_23, Player.LAETITIA_23}, minor={Player.EVERON_23})
    ])
]
...
exercises7 = [
    ...
    Exercise(episode=7, alive=players7, maximum=2000, earned=[
        Earning(money=-815, major={Player.EVERON_23, Player.KIM_LIAN_23,
                Player.THOMAS_23, Player.FRESIA_23, Player.LAETITIA_23})
    ]),
...
exercises8 = [
    ...
    Exercise(episode=8, alive=players8, maximum=2500, earned=[
        Earning(money=445, major={Player.EVERON_23, Player.KIM_LIAN_23, Player.THOMAS_23, Player.FRESIA_23})
    ]),
    # Opdracht 2: Heftig
    Exercise(episode=8, alive=players8, maximum=1500, earned=[]),
    # Opdracht 3: Zand erover
    Exercise(episode=8, alive=players8, maximum=2000, earned=[
        Earning(money=500, major={Player.EVERON_23, Player.KIM_LIAN_23, Player.FRESIA_23}, minor={Player.THOMAS_23})
    ])
]
