...
exercise1_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            ...
            minor={Player.JAIKE_20, Player.MILJUSCHKA_20, Player.NATHAN_20},
        ),
    ],
)
...
exercise2_2 = Exercise(
    ...
    maximum=1750,
    powerful=set(),
    earned=[Earning(money=-100, major={Player.TINA_20})],
)
...
exercise3_1 = Exercise(
    episode=3, alive=alive3, maximum=2250, powerful=set(), earned=[]
)
exercise3_2 = Exercise(
    ...
    earned=[
        Earning(
            money=150,
            major={Player.BUDDY_20, Player.JOHAN_20, Player.ROB_20},
            minor={Player.CLAES_20, Player.MILJUSCHKA_20},
        ),
        Earning(
            money=450,
            major={Player.JAIKE_20, Player.LEONIE_20, Player.NATHAN_20},
            minor={Player.CLAES_20, Player.MILJUSCHKA_20},
        ),
    ],
)
...
exercise4_2 = Exercise(
    episode=4, alive=alive4, maximum=2560, powerful=set(), earned=[]
)
...
exercise5_2 = Exercise(
    ...
    earned=[
        Earning(
            money=600,
            major={Player.BUDDY_20},
            minor={Player.CLAES_20, Player.LEONIE_20, Player.ROB_20},
        )
    ],
)
exercise5_3 = Exercise(
    ...
    maximum=1750,
    powerful=set(),
    earned=[Earning(money=250, major={Player.NATHAN_20})],
)
...
exercise7_2 = Exercise(
    episode=7, alive=alive7, maximum=1600, powerful=set(), earned=[]
)
...
exercise8_1 = Exercise(
    ...
    earned=[
        Earning(
            money=250,
            major={Player.NATHAN_20},
            minor={Player.MILJUSCHKA_20, Player.ROB_20},
        )
    ],
)
exercise8_3 = Exercise(
    ...
    maximum=2000,
    powerful=set(),
    earned=[Earning(money=80, major={Player.BUDDY_20})],
)
...
exercise9_1 = Exercise(
    episode=9, alive=alive6, maximum=1750, powerful=set(), earned=[]
)
exercise9_3 = Exercise(
    episode=9, alive=alive6, maximum=4500, powerful=set(), earned=[]
)
