...
exercise1_2 = Exercise(
    ...
    earned=[
        Earning(
            ...
            minor={Player.EVA_7, Player.MENNO_7, Player.NADJA_7, Player.SANDER_7},
        )
    ],
)
exercise1_3 = Exercise(
    episode=1, alive=alive1, maximum=2250, powerful=set(), earned=[]
)
...
exercise4_2 = Exercise(
    ...
    earned=[
        Earning(
            money=-1000,
            major={Player.EVA_7},
            minor={Player.ALEX_7, Player.MENNO_7, Player.NADJA_7},
        ),
        Earning(
            money=-2450,
            major={Player.EVA_7},
        ...
        Earning(
            money=-1750,
            major={Player.ALEX_7},
            minor={Player.EVA_7, Player.INGE_7, Player.MENNO_7},
        ),
        Earning(
            money=-6700,
            major={Player.NADJA_7},
            minor={
                Player.ALEX_7,
                Player.EVA_7,
                Player.INGE_7,
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=4500, powerful=set(), earned=[]
)
exercise5_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=750,
            major={Player.INGE_7},
            minor={Player.ALEX_7, Player.DICK_7, Player.PAUL_7, Player.RENATE_7},
        ),
    ],
)
...
exercise6_1 = Exercise(
    episode=6, alive=alive6, maximum=5000, powerful=set(), earned=[]
)
...
exercise6_3 = Exercise(
    ...
    maximum=5000,
    powerful=set(),
    earned=[Earning(money=5000, major={Player.EVA_7})],
)
...
exercise7_2 = Exercise(
    episode=7, alive=alive7, maximum=5000, powerful=set(), earned=[]
)
exercise7_3 = Exercise(
    ...
    maximum=3000,
    powerful=set(),
    earned=[Earning(money=3000, major={Player.PAUL_7})],
)
...
exercise8_2 = Exercise(
    ...
    earned=[
        Earning(
            money=3000,
            major={Player.RENATE_7},
            minor={Player.EVA_7, Player.INGE_7, Player.PAUL_7},
        )
    ],
)
exercise8_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=1000,
            minor={Player.EVA_7, Player.INGE_7, Player.PAUL_7, Player.RENATE_7},
        ),
    ],
)
...
exercise9_1 = Exercise(
    episode=9, alive=alive9, maximum=5000, powerful=set(), earned=[]
)
