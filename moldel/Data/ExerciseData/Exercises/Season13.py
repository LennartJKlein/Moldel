...
exercise1_2 = Exercise(
    episode=1, alive=alive1, maximum=10000, powerful=set(), earned=[]
)
...
exercise2_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1000,
            major={Player.CAROLIEN_13},
            minor={Player.KEES_13, Player.TIM_13},
        )
    ],
)
exercise2_2 = Exercise(
    ...
    earned=[
        Earning(
            money=500, major={Player.CAROLIEN_13, Player.JOEP_13, Player.PAULIEN_13}
        )
    ],
)
exercise2_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=250,
            major={Player.JANINE_13, Player.TIM_13},
            minor={
                Player.CAROLIEN_13,
                Player.DANIEL_13,
                Player.JOEP_13,
        ...
        Earning(
            money=250,
            major={Player.CAROLIEN_13, Player.TIM_13},
            minor={
                Player.DANIEL_13,
                Player.JANINE_13,
                Player.JOEP_13,
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=3000, powerful=set(), earned=[]
)
...
exercise7_1 = Exercise(
    ...
    earned=[
        Earning(
            money=500,
            major={Player.KEES_13, Player.PAULIEN_13},
            minor={Player.CAROLIEN_13, Player.DANIEL_13, Player.ZARAYDA_13},
        ),
    ],
)
...
exercise8_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1200,
            major={Player.PAULIEN_13},
            minor={Player.CAROLIEN_13, Player.KEES_13},
        ),
        Earning(
            money=400,
            major={Player.ZARAYDA_13},
            minor={Player.CAROLIEN_13, Player.KEES_13},
        ),
    ],
)
