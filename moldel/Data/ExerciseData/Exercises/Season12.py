...
exercise1_3 = Exercise(
    episode=1, alive=alive1, maximum=3000, powerful=set(), earned=[]
)
...
exercise2_2 = Exercise(
    episode=2, alive=alive2, maximum=2500, powerful=set(), earned=[]
)
...
exercise3_1 = Exercise(
    ...
    earned=[
        Earning(
            money=300,
            major={Player.ANNE_MARIE_12, Player.MAARTEN_12, Player.TIM_12},
            minor={
                Player.FRITS_12,
                Player.HADEWYCH_12,
                Player.LIESBETH_12,
        ...
        Earning(
            money=200,
            major={Player.FRITS_12, Player.LIESBETH_12, Player.WILLIAM_12},
...
exercise5_2 = Exercise(
    ...
    maximum=4500,
    powerful=set(),
    earned=[Earning(money=1500, major={Player.FRITS_12})],
)
...
exercise6_1 = Exercise(
    ...
    earned=[
        Earning(
            money=2500,
            major={Player.ANNE_MARIE_12},
            minor={Player.FRITS_12, Player.LIESBETH_12},
        )
    ],
)
...
exercise6_3 = Exercise(
    ...
    earned=[
        Earning(
            money=1000,
            major={Player.WILLIAM_12},
            minor={Player.ANNE_MARIE_12, Player.FRITS_12, Player.TIM_12},
        ),
        Earning(
            money=1000,
            major={Player.TIM_12},
            minor={Player.ANNE_MARIE_12, Player.HADEWYCH_12, Player.WILLIAM_12},
        ),
    ],
)
...
exercise9_1 = Exercise(
    ...
    earned=[
        Earning(
            money=2500,
            major={Player.ANNE_MARIE_12},
            minor={Player.HADEWYCH_12, Player.LIESBETH_12},
        ),
    ],
)
