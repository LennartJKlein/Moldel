...
exercises1 = [
    ...
    Exercise(episode=1, alive=players1, maximum=25000, powerful=set(), earned=[]),
]
...
exercises2 = [
    ...
    Exercise(episode=2, alive=players2, maximum=5000, powerful=set(), earned=[]),
    ...
    Exercise(
        ...
        earned=[
            ...
            Earning(
                money=500, major={Player.PETRA_1}, minor={Player.WILLY_1}
            ),  # antwoord 3
            Earning(
                money=500, major={Player.PETRA_1}, minor={Player.WILLY_1}
            ),  # antwoord 4
            ...
            Earning(
                money=500, major={Player.DEBORAH_1}, minor={Player.WARNER_1}
            ),  # antwoord 4
...
exercises3 = [
    ...
    Exercise(episode=3, alive=players3, maximum=10000, powerful=set(), earned=[]),
    # Opdracht 2: Vleesproeverij
    Exercise(episode=3, alive=players3, maximum=5000, powerful=set(), earned=[]),
...
exercises4 = [
    ...
    Exercise(episode=4, alive=players4, maximum=5000, powerful=set(), earned=[]),
...
exercises5 = [
    ...
    Exercise(
        ...
        maximum=10000,
        powerful=set(),
        earned=[Earning(money=10000, major={Player.ROBIN_1, Player.PETRA_1})],
    ),
...
exercises6 = [
    ...
    Exercise(episode=6, alive=players6, maximum=5000, powerful=set(), earned=[]),
...
exercises7 = [
    # Opdracht 1: Surfen
    Exercise(episode=7, alive=players7, maximum=5000, powerful=set(), earned=[]),
    # Opdracht 2: Circus
    Exercise(episode=7, alive=players7, maximum=5000, powerful=set(), earned=[]),
...
exercises8 = [
    # Opdracht 1:
    Exercise(episode=8, alive=players8, maximum=0, powerful=set(), earned=[]),
