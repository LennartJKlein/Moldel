...
exercise2_1 = Exercise(
    ...
    earned=[
        Earning(
            money=80,
            major={Player.ELLIE_21, Player.HORACE_21, Player.PATRICK_21, Player.RON_21},
            minor={
                Player.JEROEN_21,
                Player.NADJA_21,
                Player.NIKKIE_21,
        ...
        Earning(
            ...
            minor={Player.ELLIE_21, Player.HORACE_21, Player.PATRICK_21, Player.RON_21},
        ),
        Earning(
            money=2.50,
            major=set(),
...
exercise2_3 = Exercise(
    ...
    maximum=1500,
    powerful=set(),
    earned=[Earning(money=1500, major={Player.PATRICK_21}, minor=set())],
)
...
exercise3_2 = Exercise(
    ...
    earned=[
        Earning(
            money=200 * 5 / 7,
            major={Player.PATRICK_21},
            minor={Player.RON_21, Player.TYGO_21},
        ),
        Earning(
            money=200 * 5 / 7,
            major={Player.PATRICK_21, Player.PEGGY_21},
            minor={Player.RON_21, Player.TYGO_21},
        ),
        Earning(
            money=400 * 5 / 7,
        ...
        Earning(
            money=400 * 5 / 7,
            major={Player.PEGGY_21},
            minor={Player.RON_21, Player.TYGO_21},
        ),
        Earning(
            money=200 * 5 / 7,
            major={Player.JEROEN_21, Player.NIKKIE_21},
            minor={Player.ELLIE_21, Player.HORACE_21},
        ),
    ],
)
exercise3_3 = Exercise(
    ...
    earned=[
        Earning(
            money=400,
            major={Player.PATRICK_21},
            minor={Player.JEROEN_21, Player.NIKKIE_21, Player.RON_21, Player.TYGO_21},
        ),
        Earning(
            money=200,
            major={Player.NIKKIE_21},
            minor={Player.JEROEN_21, Player.RON_21, Player.TYGO_21},
        ),
        Earning(
            money=200,
            major={Player.PEGGY_21},
        ...
        Earning(
            money=200,
            major={Player.HORACE_21},
            minor={Player.ELLIE_21, Player.PATRICK_21, Player.PEGGY_21},
        ),
        Earning(
            money=200,
            major={Player.JEROEN_21},
...
exercise4_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1000,
            major={Player.ELLIE_21},
            minor={Player.PATRICK_21, Player.RON_21, Player.NIKKIE_21, Player.TYGO_21},
        ),
    ],
)
exercise4_2 = Exercise(
    episode=4, alive=alive4, maximum=2250, powerful=set(), earned=[]
)
exercise4_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=450,
            major={Player.ELLIE_21, Player.PEGGY_21, Player.TYGO_21},
            minor=set(),
        ),
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=1750, powerful=set(), earned=[]
)
exercise5_2 = Exercise(
    episode=5, alive=alive5, maximum=1500, powerful=set(), earned=[]
)
...
exercise7_2 = Exercise(
    episode=7, alive=alive7, maximum=3400, powerful=set(), earned=[]
)
