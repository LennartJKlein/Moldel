...
exercise1_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=250, major={Player.ARJEN_10, Player.HIND_10}, minor={Player.SANNE_10}
        ),
        Earning(
            money=250,
            minor={
...
exercise2_2 = Exercise(
    episode=2, alive=alive2, maximum=3000, powerful=set(), earned=[]
)
...
exercise3_2 = Exercise(
    episode=3, alive=alive3, maximum=3000, powerful=set(), earned=[]
)
exercise3_3 = Exercise(
    episode=3, alive=alive3, maximum=2000, powerful=set(), earned=[]
)
...
exercise4_2 = Exercise(
    ...
    earned=[
        Earning(
            money=1200 * 18 / 28,
            major={Player.BARBARA_10, Player.FRITS_10, Player.KIM_10, Player.SANNE_10},
            minor={Player.ARJEN_10, Player.ERIK_10, Player.HIND_10},
        ),
        Earning(
            money=1200 * 3 / 28,
            major={Player.ARJEN_10},
            minor={
                Player.BARBARA_10,
                Player.ERIK_10,
                Player.FRITS_10,
...
exercise4_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=100,
            major={Player.BARBARA_10},
            minor={Player.ARJEN_10, Player.SANNE_10},
        ),
        Earning(
            money=200,
            major={Player.ERIK_10},
            minor={Player.ARJEN_10, Player.BARBARA_10, Player.SANNE_10},
        ),
        Earning(
            money=400,
            major={Player.KIM_10},
            minor={Player.ARJEN_10, Player.BARBARA_10, Player.ERIK_10, Player.SANNE_10},
        ),
        Earning(
            money=800,
            major={Player.HIND_10},
...
exercise5_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1000,
            major={Player.ERIK_10, Player.SANNE_10},
            minor={Player.ARJEN_10, Player.FRITS_10, Player.HIND_10, Player.KIM_10},
        ),
        Earning(
            money=500,
            major={Player.ERIK_10, Player.HIND_10},
            minor={Player.ARJEN_10, Player.FRITS_10, Player.KIM_10, Player.SANNE_10},
        ),
    ],
)
exercise5_2 = Exercise(
    ...
    earned=[
        Earning(
            money=1500,
            major={Player.SANNE_10},
            minor={Player.ARJEN_10, Player.FRITS_10, Player.HIND_10},
        )
    ],
)
exercise5_3 = Exercise(
    ...
    earned=[
        Earning(
            money=500,
            major={Player.ARJEN_10},
            minor={Player.ERIK_10, Player.FRITS_10, Player.HIND_10},
        ),
        Earning(
            money=300,
            major={Player.ERIK_10},
            minor={Player.ARJEN_10, Player.KIM_10, Player.SANNE_10},
        ),
        Earning(
            money=100,
            major={Player.FRITS_10},
            minor={Player.ARJEN_10, Player.KIM_10, Player.SANNE_10},
        ),
        Earning(
            money=100,
            major={Player.ARJEN_10, Player.KIM_10},
            minor={Player.ERIK_10, Player.FRITS_10, Player.HIND_10},
        ),
        Earning(
            money=100,
            major={Player.ERIK_10},
            minor={Player.ARJEN_10, Player.HIND_10, Player.KIM_10, Player.SANNE_10},
        ),
        Earning(
            money=500,
            minor={
...
exercise6_3 = Exercise(
    ...
    earned=[
        Earning(
            money=1500,
            major={Player.FRITS_10},
            minor={Player.ARJEN_10, Player.ERIK_10, Player.KIM_10, Player.SANNE_10},
        ),
        Earning(
            money=500, major={Player.FRITS_10}, minor={Player.ARJEN_10, Player.KIM_10}
        ),
        Earning(
            money=500, major={Player.FRITS_10}, minor={Player.ERIK_10, Player.SANNE_10}
        ),
    ],
)
exercise6_4 = Exercise(
    episode=6,
    alive=alive6,
    maximum=None,
    powerful=set(),
...
exercise7_2 = Exercise(
    episode=7, alive=alive7, maximum=2500, powerful=set(), earned=[]
)
...
exercise8_1 = Exercise(
    episode=8, alive=alive8, maximum=2500, powerful=set(), earned=[]
)
exercise8_2 = Exercise(
    ...
    maximum=3000,
    powerful=set(),
    earned=[Earning(money=-1000, major={Player.SANNE_10})],
)
...
exercise9_1 = Exercise(
    episode=9, alive=alive9, maximum=2000, powerful=set(), earned=[]
)
exercise9_2 = Exercise(
    ...
    earned=[
        Earning(
            money=500, major={Player.SANNE_10}, minor={Player.FRITS_10, Player.KIM_10}
        ),
        Earning(
            money=1750, major={Player.FRITS_10}, minor={Player.KIM_10, Player.SANNE_10}
        ),
        Earning(
            money=250, major={Player.KIM_10}, minor={Player.FRITS_10, Player.SANNE_10}
        ),
