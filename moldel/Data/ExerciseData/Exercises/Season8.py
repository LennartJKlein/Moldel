...
exercise1_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=1000,
            major={Player.DUNYA_8},
            minor={Player.GEORGINA_8, Player.NICOLETTE_8},
        ),
    ],
)
...
exercise2_3 = Exercise(
    episode=2, alive=alive2, maximum=10000, powerful=set(), earned=[]
)
...
exercise3_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=250,
            major={Player.EDO_8},
            minor={Player.COEN_8, Player.DENNIS_8, Player.REGINA_8},
        ),
        Earning(
            money=250,
            major={Player.DENNIS_8},
            minor={
                Player.COEN_8,
                Player.DUNYA_8,
                Player.EDO_8,
...
exercise3_3 = Exercise(
    ...
    earned=[
        Earning(
            money=500,
            major={Player.PATRICK_8},
            minor={Player.DENNIS_8, Player.EDO_8, Player.GEORGINA_8, Player.JORIS_8},
        )
    ],
)
...
exercise4_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=500, major={Player.DUNYA_8}, minor={Player.JORIS_8, Player.REGINA_8}
        ),
...
exercise5_2 = Exercise(
    ...
    maximum=None,
    powerful=set(),
    earned=[Earning(money=-1000, major={Player.REGINA_8})],
)
exercise5_3 = Exercise(
    ...
    earned=[
        Earning(
            money=2500, major={Player.DENNIS_8}, minor={Player.EDO_8, Player.JORIS_8}
        )
    ],
)
...
exercise6_1 = Exercise(
    episode=6, alive=alive6, maximum=4000, powerful=set(), earned=[]
)
...
exercise7_1 = Exercise(
    ...
    earned=[
        Earning(
            money=2500 / 3,
            major={Player.EDO_8},
            minor={Player.PATRICK_8, Player.REGINA_8},
        ),
        Earning(
            money=2500 / 3 - 250,
            major={Player.PATRICK_8},
            minor={Player.EDO_8, Player.REGINA_8},
        ),
        Earning(
            money=2500 / 3 - 250,
            major={Player.REGINA_8},
            minor={Player.EDO_8, Player.PATRICK_8},
        ),
    ],
)
...
exercise7_3 = Exercise(
    ...
    earned=[
        Earning(
            money=500, major={Player.DENNIS_8, Player.EDO_8}, minor={Player.REGINA_8}
        ),
        Earning(
            money=750,
            major={Player.DUNYA_8},
            minor={Player.DENNIS_8, Player.PATRICK_8, Player.REGINA_8},
        ),
    ],
)
...
exercise8_2 = Exercise(
    episode=8, alive=alive8, maximum=3000, powerful=set(), earned=[]
)
exercise8_3 = Exercise(
    ...
    maximum=3000,
    powerful=set(),
    earned=[Earning(money=3000, major={Player.EDO_8})],
)
...
exercise9_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1500, major={Player.EDO_8}, minor={Player.DENNIS_8, Player.REGINA_8}
        )
    ],
)
