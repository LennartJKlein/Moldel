...
exercise2_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=120 * 0.86,
            major={Player.EMILIO_18},
            minor={Player.JAN_18, Player.OLCAY_18},
        ),
        Earning(
            money=200 * 0.86,
            major={Player.JEAN_MARC_18},
            minor={Player.EMILIO_18, Player.JAN_18, Player.OLCAY_18},
        ),
        Earning(
            money=600 * 0.86,
            major={Player.RUBEN_18},
            minor={
                Player.EMILIO_18,
                Player.JAN_18,
                Player.JEAN_MARC_18,
...
exercise3_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=450,
            major={Player.JAN_18, Player.STINE_18},
            minor={Player.EMILIO_18, Player.LOES_18, Player.SIMONE_18},
        ),
    ],
)
exercise3_2 = Exercise(
    ...
    earned=[
        Earning(
            money=-500,
            major={Player.BELLA_18},
            minor={Player.EMILIO_18, Player.RUBEN_18},
        ),
        Earning(
            money=250, major={Player.LOES_18}, minor={Player.EMILIO_18, Player.RUBEN_18}
        ),
        Earning(
            money=-500,
            major={Player.OLCAY_18, Player.STINE_18},
            minor={Player.JAN_18, Player.SIMONE_18},
        ),
        Earning(
            money=-500,
            major={Player.SIMONE_18},
...
exercise3_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=800,
            major={Player.BELLA_18, Player.JAN_18, Player.LOES_18, Player.SIMONE_18},
...
exercise4_1 = Exercise(
    episode=4, alive=alive4, maximum=1500, powerful=set(), earned=[]
)
...
exercise5_2 = Exercise(
    ...
    maximum=2000,
    powerful=set(),
    earned=[Earning(money=1000, major={Player.LOES_18}, minor={Player.RUBEN_18})],
)
...
exercise6_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=200, major={Player.OLCAY_18}, minor={Player.JAN_18, Player.RUBEN_18}
        ),
    ],
)
exercise6_2 = Exercise(
    ...
    earned=[
        Earning(
            money=750,
            major={Player.JAN_18, Player.RUBEN_18, Player.SIMONE_18},
            minor={Player.OLCAY_18, Player.STINE_18},
        ),
...
exercise7_1 = Exercise(
    ...
    earned=[
        Earning(
            money=250,
            major={Player.JAN_18},
            minor={Player.RUBEN_18, Player.OLCAY_18, Player.SIMONE_18, Player.STINE_18},
        ),
        Earning(
            money=500, major={Player.SIMONE_18}, minor={Player.JAN_18, Player.RUBEN_18}
        ),
    ],
)
exercise7_2 = Exercise(
    episode=7, alive=alive7, maximum=1250, powerful=set(), earned=[]
)
exercise7_3 = Exercise(
    episode=7, alive=alive7, maximum=1500, powerful=set(), earned=[]
)
...
exercise8_1 = Exercise(
    episode=8, alive=alive8, maximum=1000, powerful=set(), earned=[]
)
exercise8_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=200,
            minor={Player.JAN_18, Player.OLCAY_18, Player.RUBEN_18, Player.SIMONE_18},
        ),
    ],
)
...
exercise9_1 = Exercise(
    episode=9, alive=alive9, maximum=1000, powerful=set(), earned=[]
)
