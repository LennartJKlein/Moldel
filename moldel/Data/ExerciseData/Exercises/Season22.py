...
exercise1_3 = Exercise(
    ...
    earned=[
        Earning(
            money=900,
            major={Player.FLORENTIJN_22, Player.REMCO_22},
            minor={
                Player.CHARLOTTE_22,
                Player.ERIK_22,
                Player.JOSHUA_22,
...
exercise2_3 = Exercise(
    ...
    earned=[
        Earning(
            money=70,
            major={Player.LAKSHMI_22, Player.MARIJE_22},
            minor={Player.FLORENTIJN_22, Player.JOSHUA_22, Player.RENEE_22},
        ),
        Earning(
            money=210,
            major={Player.ERIK_22, Player.SPLINTER_22},
            minor={Player.FLORENTIJN_22, Player.JOSHUA_22, Player.RENEE_22},
        ),
        Earning(
            money=-350,
...
exercise3_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            ...
            minor={Player.CHARLOTTE_22, Player.SPLINTER_22},
        ),
        Earning(
            money=500,
            major={Player.ROCKY_22},
            minor={Player.JOSHUA_22, Player.FLORENTIJN_22},
        ),
        Earning(
            money=500,
            major={Player.ROCKY_22},
            minor={Player.LAKSHMI_22, Player.MARIJE_22},
        ),
    ],
)
...
exercise4_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            ...
            minor={Player.LAKSHMI_22, Player.ROCKY_22, Player.SPLINTER_22},
        ),
    ],
)
exercise4_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            ...
            minor={Player.LAKSHMI_22, Player.SPLINTER_22},
        ),
        Earning(
            money=150,
            major={Player.CHARLOTTE_22, Player.MARIJE_22},
...
exercise4_3 = Exercise(
    ...
    earned=[
        Earning(
            money=2000,
            major={Player.JOSHUA_22, Player.MARIJE_22},
            minor={
                Player.CHARLOTTE_22,
                Player.LAKSHMI_22,
                Player.RENEE_22,
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=1900, powerful=set(), earned=[]
)
exercise5_2 = Exercise(
    ...
    earned=[
        Earning(
            money=-5000, major={Player.CHARLOTTE_22, Player.MARIJE_22, Player.ROCKY_22}
        )
    ],
)
exercise5_3 = Exercise(
    ...
    earned=[
        Earning(
            money=850,
            major={Player.MARIJE_22},
            minor={Player.CHARLOTTE_22, Player.ROCKY_22},
        )
    ],
)
...
exercise7_1 = Exercise(
    episode=7, alive=alive7, maximum=1750, powerful=set(), earned=[]
)
...
exercise7_3 = Exercise(
    ...
    earned=[
        Earning(
            money=300 * 8 / 13,
            major={Player.CHARLOTTE_22},
            minor={Player.MARIJE_22, Player.ROCKY_22, Player.SPLINTER_22},
        ),
        Earning(
            money=200 * 8 / 13,
            major={Player.MARIJE_22},
        ...
        Earning(
            money=100 * 8 / 13,
            major={Player.MARIJE_22, Player.RENEE_22},
            minor={Player.CHARLOTTE_22, Player.ROCKY_22, Player.SPLINTER_22},
        ),
        Earning(
            money=200 * 8 / 13,
            major={Player.SPLINTER_22},
...
exercise8_1 = Exercise(
    episode=8, alive=alive8, maximum=1500, powerful=set(), earned=[]
)
exercise8_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=450,
            major={Player.CHARLOTTE_22},
            minor={Player.RENEE_22, Player.ROCKY_22, Player.SPLINTER_22},
        ),
        Earning(
            money=225,
            minor={
...
exercise9_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=300,
            major={Player.CHARLOTTE_22},
            minor={Player.RENEE_22, Player.ROCKY_22},
        ),
        Earning(
            money=100, minor={Player.CHARLOTTE_22, Player.RENEE_22, Player.ROCKY_22}
        ),
    ],
)
