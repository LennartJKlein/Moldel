...
exercise1_1 = Exercise(
    ...
    earned=[
        Earning(
            money=400,
            major={Player.JENNIFER_14, Player.SUSAN_14},
            minor={
                Player.AAF_14,
                Player.DAPHNE_14,
                Player.FREEK_14,
...
exercise2_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=500,
            major={Player.FREEK_14},
            minor={Player.OWEN_14, Player.SUSAN_14, Player.TYGO_14},
        ),
...
exercise3_2 = Exercise(
    episode=3, alive=alive3, maximum=3400, powerful=set(), earned=[]
)
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=2500, powerful=set(), earned=[]
)
exercise5_2 = Exercise(
    ...
    earned=[
        Earning(
            money=2500,
            major={Player.AAF_14},
            minor={Player.JAN_WILLEM_14, Player.TYGO_14},
        ),
    ],
)
...
exercise6_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1250, major={Player.FREEK_14, Player.SOFIE_14}, minor={Player.TYGO_14}
        ),
    ],
)
...
exercise7_1 = Exercise(
    ...
    earned=[
        Earning(
            money=2000,
            major={Player.JAN_WILLEM_14},
            minor={Player.FREEK_14, Player.SUSAN_14},
        ),
    ],
)
...
exercise7_3 = Exercise(
    ...
    maximum=3000,
    powerful=set(),
    earned=[Earning(money=250, major={Player.JAN_WILLEM_14})],
)
