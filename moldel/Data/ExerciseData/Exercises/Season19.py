...
exercise1_3 = Exercise(
    ...
    earned=[
        Earning(
            money=300,
            major={Player.NIKKIE_19},
            minor={Player.RICK_PAUL_19, Player.NIELS_19},
        )
    ],
)
...
exercise2_1 = Exercise(
    ...
    earned=[
        Earning(
            money=300,
            major={Player.NIKKIE_19, Player.RICK_PAUL_19},
            minor={
                Player.EVELIEN_19,
                Player.EVI_19,
                Player.JAMIE_19,
...
exercise3_1 = Exercise(
    episode=3, alive=alive3, maximum=1500, powerful=set(), earned=[]
)
...
exercise4_1 = Exercise(
    ...
    earned=[
        Earning(
            money=100,
            major={Player.EVELIEN_19},
            minor={Player.JAMIE_19, Player.NIELS_19, Player.SINAN_19},
        ),
        Earning(
            money=150,
            major={Player.ROBERT_19},
            minor={Player.JAMIE_19, Player.SARAH_19, Player.SINAN_19},
        ),
        Earning(
            money=250, major={Player.MEREL_19}, minor={Player.JAMIE_19, Player.SINAN_19}
        ),
    ],
)
...
exercise5_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1800,
            major={Player.JAMIE_19, Player.NIELS_19, Player.SINAN_19},
            minor={
                Player.MEREL_19,
                Player.RICK_PAUL_19,
                Player.ROBERT_19,
...
exercise5_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=800,
            major={Player.MEREL_19, Player.ROBERT_19, Player.SARAH_19},
            minor={
                Player.JAMIE_19,
                Player.NIELS_19,
                Player.RICK_PAUL_19,
...
exercise5_3 = Exercise(
    ...
    maximum=1500,
    powerful=set(),
    earned=[Earning(money=750, major={Player.SARAH_19}, minor={Player.MEREL_19})],
)
...
exercise8_1 = Exercise(
    episode=8, alive=alive8, maximum=1550, powerful=set(), earned=[]
)
exercise8_2 = Exercise(
    ...
    earned=[
        Earning(
            money=250, major={Player.MEREL_19}, minor={Player.NIELS_19, Player.SINAN_19}
        ),
        Earning(
            money=250, major={Player.SARAH_19}, minor={Player.NIELS_19, Player.SINAN_19}
        ),
        Earning(
            money=250,
            major={Player.NIELS_19},
            minor={Player.MEREL_19, Player.SARAH_19, Player.SINAN_19},
        ),
        Earning(
            money=250,
            major={Player.SARAH_19},
            minor={Player.MEREL_19, Player.NIELS_19, Player.SINAN_19},
        ),
        Earning(
            money=250,
            major={Player.MEREL_19},
            minor={Player.NIELS_19, Player.SARAH_19, Player.SINAN_19},
        ),
    ],
)
...
exercise9_1 = Exercise(
    ...
    earned=[
        Earning(
            money=250, major={Player.NIELS_19}, minor={Player.MEREL_19, Player.SARAH_19}
        ),
    ],
)
