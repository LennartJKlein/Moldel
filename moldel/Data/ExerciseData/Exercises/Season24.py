...
exercises5 = [
    ...
    Exercise(
        ...
        earned=[
            Earning(
                money=100,
                major={Player.RANOMI_24, Player.DANIEL_24},
                minor={Player.JURRE_24},
            ),
            Earning(
                money=600,
                major={Player.RANOMI_24, Player.DANIEL_24},
                minor={Player.ANKE_24},
            ),
        ],
    ),
...
exercises6 = [
    ...
    Exercise(
        ...
        earned=[
            Earning(
                money=1000, major={Player.SOY_24, Player.DANIEL_24, Player.ANKE_24}
            ),
        ],
    ),
    ...
    Exercise(episode=6, alive=players6, maximum=2000, powerful=set(), earned=[]),
    # Opdracht 4: Roadtrip
    Exercise(
        episode=6,
        alive=players6,
        ...
        earned=[
            Earning(
                money=-500,
                major={Player.SOY_24, Player.DANIEL_24},
                minor={Player.ANKE_24},
            ),
            Earning(
                money=-500, major={Player.SOY_24, Player.DANIEL_24, Player.ANKE_24}
            ),
            Earning(
                money=-500, major={Player.RANOMI_24, Player.NABIL_24, Player.JURRE_24}
            ),
            Earning(
                money=-500, major={Player.RANOMI_24, Player.NABIL_24, Player.JURRE_24}
            ),
...
exercises8 = [
    ...
    Exercise(episode=8, alive=players8, maximum=2000, powerful=set(), earned=[]),
    ...
    Exercise(
        ...
        earned=[
            Earning(
                money=1250,
                major={Player.RANOMI_24, Player.SOY_24},
                minor={Player.JURRE_24, Player.DANIEL_24},
            ),
...
exercises9 = [
    ...
    Exercise(episode=9, alive=players9, maximum=2500, powerful=set(), earned=[]),
]
