...
exercise1_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=30, major={Player.HANNA_11}, minor={Player.JAN_11, Player.MIRYANNA_11}
        ),
        Earning(
            money=40,
            major={Player.HORACE_11},
            minor={Player.HANNA_11, Player.JAN_11, Player.MIRYANNA_11},
        ),
    ],
)
exercise1_2 = Exercise(
    episode=1, alive=alive1, maximum=2500, powerful=set(), earned=[]
)
...
exercise3_1 = Exercise(
    ...
    earned=[
        Earning(
            money=1000,
            major={Player.MIRYANNA_11},
            minor={Player.JAN_11, Player.KARIN_11, Player.PEPIJN_11},
        ),
    ],
)
exercise3_2 = Exercise(
    episode=3, alive=alive3, maximum=2500, powerful=set(), earned=[]
)
...
exercise4_1 = Exercise(
    episode=4, alive=alive4, maximum=3000, powerful=set(), earned=[]
)
exercise4_3 = Exercise(
    episode=4, alive=alive4, maximum=2500, powerful=set(), earned=[]
)
...
exercise5_1 = Exercise(
    ...
    earned=[
        Earning(
            money=250,
            major={Player.ANNA_11},
            minor={Player.ART_11, Player.JAN_11, Player.KARIN_11, Player.PATRICK_11},
        ),
        Earning(
            money=500,
            major={Player.ANNA_11},
            minor={Player.ART_11, Player.JAN_11, Player.PATRICK_11},
        ),
    ],
)
exercise5_2 = Exercise(
    ...
    earned=[
        Earning(
            money=250, major={Player.ANNA_11}, minor={Player.JAN_11, Player.KARIN_11}
        ),
        Earning(
            money=250,
            major={Player.ANNA_11},
            minor={Player.PEPIJN_11, Player.SOUNDOS_11},
        ),
    ],
)
exercise5_3 = Exercise(
    ...
    earned=[
        Earning(
            money=500,
            major={Player.PATRICK_11},
            minor={Player.ANNA_11, Player.ART_11, Player.JAN_11, Player.PEPIJN_11},
        ),
        Earning(
            money=250,
            major={Player.PEPIJN_11},
            minor={Player.ANNA_11, Player.ART_11, Player.JAN_11, Player.PATRICK_11},
        ),
        Earning(
            money=250,
            major={Player.ANNA_11},
            minor={Player.ART_11, Player.JAN_11, Player.PATRICK_11, Player.PEPIJN_11},
        ),
        Earning(
            money=250,
            major={Player.PEPIJN_11},
            minor={Player.ANNA_11, Player.ART_11, Player.JAN_11, Player.SOUNDOS_11},
        ),
        Earning(
            money=250,
            major={Player.JAN_11},
            minor={Player.ANNA_11, Player.ART_11, Player.PEPIJN_11},
        ),
        Earning(
            money=1500,
            major={Player.PATRICK_11},
...
exercise6_2 = Exercise(
    episode=6, alive=alive6, maximum=2500, powerful=set(), earned=[]
)
...
exercise7_2 = Exercise(
    ...
    earned=[
        Earning(
            money=200,
            major={Player.ANNA_11},
            minor={Player.ART_11, Player.PATRICK_11, Player.PEPIJN_11},
        ),
        Earning(
            money=200,
            major={Player.ART_11},
            minor={Player.ANNA_11, Player.PATRICK_11, Player.PEPIJN_11},
        ),
        Earning(
            money=200,
            major={Player.KARIN_11},
            minor={Player.ANNA_11, Player.ART_11, Player.PATRICK_11, Player.PEPIJN_11},
        ),
        Earning(
            money=200,
            major={Player.PATRICK_11},
        ...
        Earning(
            money=200,
            major={Player.PEPIJN_11},
            minor={Player.ANNA_11, Player.ART_11, Player.PATRICK_11},
        ),
    ],
)
...
exercise8_3 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=200,
            major={Player.ANNA_11},
            minor={Player.KARIN_11, Player.PATRICK_11},
        ),
    ],
)
...
exercise9_1 = Exercise(
    ...
    maximum=None,
    powerful=set(),
    earned=[Earning(money=700, major={Player.KARIN_11}, minor={Player.SOUNDOS_11})],
)
exercise9_2 = Exercise(
    episode=9, alive=alive9, maximum=2500, powerful=set(), earned=[]
)
exercise9_3 = Exercise(
    episode=9,
    alive=alive9,
    maximum=2000,
    powerful=set(),
    earned=[
        Earning(
            money=600,
            major={Player.SOUNDOS_11},
            minor={Player.KARIN_11, Player.PATRICK_11},
        ),
        Earning(
            money=400, major={Player.ART_11}, minor={Player.KARIN_11, Player.PATRICK_11}
        ),
        Earning(
            money=200, major={Player.KARIN_11}, minor={Player.ART_11, Player.SOUNDOS_11}
        ),
        Earning(
            money=200,
            major={Player.PATRICK_11},
            minor={Player.ART_11, Player.SOUNDOS_11},
        ),
    ],
)
...
exercise10_1 = Exercise(
    ...
    earned=[
        Earning(
            money=600,
            major={Player.PATRICK_11},
            minor={Player.KARIN_11, Player.SOUNDOS_11},
        ),
        Earning(
            money=1200,
            major={Player.ART_11},
