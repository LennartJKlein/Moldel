...
exercise2_3 = Exercise(
    episode=2, alive=alive2, maximum=1000, powerful=set(), earned=[]
)
...
# 4x (Major: Thomas) (€500 missing, so Roos, Sanne, Thomas only earn €250) (€1130 positive powerful=set(),earned)
# Opdracht 2 (Maximaal: €4000):
# €500 (Major: Sigrid), €500 (Major: Imanuelle), €500 (Major: Sigrid), €500 (Major: Sigrid), €500 (Major: Sigrid)
# For all powerful=set(),earned (Minor: Diederik, Jeroen, Jochem, Roos, Sanne, Thomas)
...
exercise3_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=250,
            major={Player.ROOS_17, Player.SANNE_17},
            minor={
                Player.DIEDERIK_17,
                Player.IMANUELLE_17,
                Player.JEROEN_17,
...
exercise4_3 = Exercise(
    ...
    earned=[
        Earning(
            money=-2700,
            major={Player.DIEDERIK_17},
            minor={Player.IMANUELLE_17, Player.JOCHEM_17, Player.THOMAS_17},
        ),
        Earning(
            money=-2000,
            major={Player.SANNE_17},
            minor={Player.JOCHEM_17, Player.THOMAS_17},
        ),
        Earning(
            money=-3500,
            major={Player.JOCHEM_17},
            minor={Player.SIGRID_17, Player.THOMAS_17},
        ),
    ],
)
...
exercise5_1 = Exercise(
    episode=5, alive=alive5, maximum=12000, powerful=set(), earned=[]
)
...
exercise6_1 = Exercise(
    ...
    earned=[
        Earning(
            money=150,
            major={Player.JOCHEM_17},
            minor={Player.SANNE_17, Player.THOMAS_17},
        ),
        Earning(
            money=200,
            major={Player.IMANUELLE_17},
...
exercise8_2 = Exercise(
    ...
    earned=[
        Earning(
            money=300,
            major={Player.THOMAS_17},
            minor={Player.DIEDERIK_17, Player.JOCHEM_17},
        ),
        Earning(
            money=600,
            major={Player.SANNE_17},
...
exercise9_2 = Exercise(
    episode=9, alive=alive9, maximum=12160, powerful=set(), earned=[]
)
