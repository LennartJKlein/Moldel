...
exercise2_1 = Exercise(
    ...
    maximum=10000,
    powerful=set(),
    earned=[Earning(money=2300, major={Player.ANNIEK_9, Player.HANS_9})],
)
exercise2_3 = Exercise(
    ...
    earned=[
        Earning(
            money=500, major={Player.RICK_9}, minor={Player.ANNIEK_9, Player.DENNIS_9}
        ),
...
exercise3_3 = Exercise(
    ...
    earned=[
        Earning(
            money=400,
            major={Player.FROUKJE_9},
            minor={Player.DENNIS_9, Player.SEBASTIAAN_9},
        ),
        Earning(
            money=400, major={Player.VIVIENNE_9}, minor={Player.HANS_9, Player.RICK_9}
        ),
        Earning(
            money=2000,
            major={Player.VIVIENNE_9},
            minor={Player.DENNIS_9, Player.HANS_9, Player.JON_9, Player.RICK_9},
        ),
        Earning(
            money=400, major={Player.ANNIEK_9}, minor={Player.JON_9, Player.PAULA_9}
        ),
    ],
)
...
exercise5_1 = Exercise(
    ...
    earned=[
        Earning(
            money=2500, major={Player.DENNIS_9}, minor={Player.JON_9, Player.VIVIENNE_9}
        )
    ],
)
...
exercise6_2 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=250, major={Player.ANNIEK_9}, minor={Player.JON_9, Player.RICK_9}
        ),
        Earning(money=250, major={Player.SEBASTIAAN_9}),
        Earning(money=250, major={Player.DENNIS_9, Player.RICK_9}),
        Earning(
            money=250, major={Player.JON_9}, minor={Player.ANNIEK_9, Player.RICK_9}
        ),
    ],
)
...
exercise7_3 = Exercise(
    ...
    earned=[
        Earning(
            money=850, major={Player.VIVIENNE_9}, minor={Player.JON_9, Player.RICK_9}
        ),
        Earning(
            money=850, major={Player.JON_9, Player.VIVIENNE_9}, minor={Player.RICK_9}
        ),
    ],
)
...
exercise8_1 = Exercise(
    ...
    earned=[
        ...
        Earning(
            money=300,
            major={Player.VIVIENNE_9},
            minor={Player.ANNIEK_9, Player.DENNIS_9, Player.JON_9},
        ),
    ],
)
...
exercise9_2 = Exercise(
    ...
    earned=[
        Earning(
            money=850, major={Player.VIVIENNE_9}, minor={Player.ANNIEK_9, Player.JON_9}
        )
    ],
)
